<?php /* Smarty version Smarty-3.1.19, created on 2017-08-03 04:17:50
         compiled from "D:\wamp64\www\ps\themes\leo_tshirt\order-opc-new-account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:97015982dc2e9f49d7-43126871%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ace131c789173d9a3679cf163e8c61fbbf022f68' => 
    array (
      0 => 'D:\\wamp64\\www\\ps\\themes\\leo_tshirt\\order-opc-new-account.tpl',
      1 => 1468838110,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '97015982dc2e9f49d7-43126871',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5982dc2fc5de22_47103642',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5982dc2fc5de22_47103642')) {function content_5982dc2fc5de22_47103642($_smarty_tpl) {?><div id="opc_new_account" class="opc-main-block">
...
" id="openLoginFormBlock">&raquo; <?php echo smartyTranslate(array('s'=>'Click here'),$_smarty_tpl);?>
			...
			<div id="login_form_content" style="display:none;">
				...
				<div class="form-group">
					<label class="control-label col-sm-4 col-md-4" for="login_email"><?php echo smartyTranslate(array('s'=>'Email address'),$_smarty_tpl);?>
</label>
				...
				<div class="form-group">
					<label class="control-label col-sm-4 col-md-4" for="login_passwd"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
</label>
					<div class="col-sm-6 col-md-6">
...
" /><?php }?>
					<button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-outline button-medium"><span><i class="fa fa-lock left"></i><?php echo smartyTranslate(array('s'=>'Sign in'),$_smarty_tpl);?>
</span></button>
				</p>
					</div>
				</div>
...
" method="post" id="new_account_form" class="std form-horizontal" autocomplete="on" autofill="on">
		<fieldset>
			<div class="box">
				...
				<div id="opc_account_choice" class="row">
					<div class="col-xs-12 col-md-6">
						...
						<p class="opc-button">
							<button type="submit" class="btn btn-outline button button-medium exclusive" id="opc_guestCheckout"><span><?php echo smartyTranslate(array('s'=>'Guest checkout'),$_smarty_tpl);?>
</span></button>
						</p>
					</div>
					<div class="col-xs-12 col-md-6">
						...
						<p class="opc-button">
							<button type="submit" class="btn btn-outline button button-medium exclusive" id="opc_createAccount"><span><i class="fa fa-user left"></i><?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
</span></button>
						</p>
					</div>
				</div>
...
<?php } else { ?>0<?php }?>" />
					...
					<label class="control-label col-sm-4 col-md-4" for="email"><?php echo smartyTranslate(array('s'=>'Email'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<label class="control-label col-sm-4 col-md-4" for="passwd"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
					...
					<label class="control-label col-sm-4 col-md-4"><?php echo smartyTranslate(array('s'=>'Social title'),$_smarty_tpl);?>
</label>
					<div class="col-sm-6 col-md-6">
...
"<?php if (isset($_POST['id_gender'])&&$_POST['id_gender']==$_smarty_tpl->tpl_vars['gender']->value->id_gender||(isset($_smarty_tpl->tpl_vars['guestInformations']->value)&&$_smarty_tpl->tpl_vars['guestInformations']->value['id_gender']==$_smarty_tpl->tpl_vars['gender']->value->id_gender)) {?> checked="checked"<?php }?> />
					...
					<label class="control-label col-sm-4 col-md-4" for="firstname"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<div class="required form-group">
					<label class="control-label col-sm-4 col-md-4" for="lastname"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<label class="control-label col-sm-4 col-md-4"><?php echo smartyTranslate(array('s'=>'Date of Birth'),$_smarty_tpl);?>
</label>
					<div class="col-sm-6 col-md-6">
						<div class="row">
...
?>
					<?php if ($_smarty_tpl->tpl_vars['field_name']->value=="company") {?>
						...
						<label class="control-label col-sm-4 col-md-4" for="company"><?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>
...
<?php }?>" />
					...
					<div id="vat_number_block" style="display:none;">
						<div class="form-group">
						<label class="control-label col-sm-4 col-md-4" for="vat_number"><?php echo smartyTranslate(array('s'=>'VAT number'),$_smarty_tpl);?>
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <sup>*</sup><?php }?></label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<label class="control-label col-sm-4 col-md-4" for="dni"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<div class="required text form-group">
					<label class="control-label col-sm-4 col-md-4" for="address1"><?php echo smartyTranslate(array('s'=>'Address'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<label class="control-label col-sm-4 col-md-4" for="address2"><?php echo smartyTranslate(array('s'=>'Address (Line 2)'),$_smarty_tpl);?>
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <sup>*</sup><?php }?></label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<label class="control-label col-sm-4 col-md-4" for="postcode"><?php echo smartyTranslate(array('s'=>'Zip / Postal code'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>"/>
					...
					<div class="required text form-group">
					<label class="control-label col-sm-4 col-md-4" for="city"><?php echo smartyTranslate(array('s'=>'City'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<label class="control-label col-sm-4 col-md-4" for="id_country"><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
...
"<?php if ((isset($_smarty_tpl->tpl_vars['guestInformations']->value)&&isset($_smarty_tpl->tpl_vars['guestInformations']->value['id_country'])&&$_smarty_tpl->tpl_vars['guestInformations']->value['id_country']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_smarty_tpl->tpl_vars['guestInformations']->value)&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])) {?> selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
					...
					<label class="control-label col-sm-4 col-md-4" for="id_state"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<label class="control-label col-sm-4 col-md-4" for="other"><?php echo smartyTranslate(array('s'=>'Additional information'),$_smarty_tpl);?>
</label>
					<div class="col-sm-6 col-md-6">
					...
					<div class="form-group is_customer_param">
					<label class="control-label col-sm-4 col-md-4" for="phone"><?php echo smartyTranslate(array('s'=>'Home phone'),$_smarty_tpl);?>
...
<?php }?>" />
					...
					<label class="control-label col-sm-4 col-md-4" for="phone_mobile"><?php echo smartyTranslate(array('s'=>'Mobile phone'),$_smarty_tpl);?>
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?> <sup>**</sup><?php }?></label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>
						...
						<div class="inline-infos required"><label class="col-sm-offset-4 col-sm-6 col-md-offset-4 col-md-6">** <?php echo smartyTranslate(array('s'=>'You must register at least one phone number.'),$_smarty_tpl);?>
</label></div>
					<?php }?>
...
?>
						<?php if ($_smarty_tpl->tpl_vars['field_name']->value=="company") {?>
						<div class="form-group">
						<label class="control-label col-sm-4 col-md-4" for="company_invoice"><?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <sup>*</sup><?php }?></label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>" />
						...
						<div id="vat_number_block_invoice" class="is_customer_param" style="display:none;">
							<div class="form-group">
							<label class="control-label col-sm-4 col-md-4" for="vat_number_invoice"><?php echo smartyTranslate(array('s'=>'VAT number'),$_smarty_tpl);?>
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <sup>*</sup><?php }?></label>
							<div class="col-sm-6 col-md-6">
...
<?php }?>" />
						...
						<label class="control-label col-sm-4 col-md-4" for="dni_invoice"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
 <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>" />
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="firstname") {?>
						<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4" for="firstname_invoice"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="lastname") {?>
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4" for="lastname_invoice"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="address1") {?>
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4" for="address1_invoice"><?php echo smartyTranslate(array('s'=>'Address'),$_smarty_tpl);?>
 <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<div class="form-group <?php if (!in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> is_customer_param<?php }?>">
						<label class="control-label col-sm-4 col-md-4" for="address2_invoice"><?php echo smartyTranslate(array('s'=>'Address (Line 2)'),$_smarty_tpl);?>
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <sup>*</sup><?php }?></label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<div class="required postcode_invoice form-group">
						<label class="control-label col-sm-4 col-md-4" for="postcode_invoice"><?php echo smartyTranslate(array('s'=>'Zip / Postal Code'),$_smarty_tpl);?>
 <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>"/>
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="city") {?>
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4" for="city_invoice"><?php echo smartyTranslate(array('s'=>'City'),$_smarty_tpl);?>
 <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>" />
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="country"||$_smarty_tpl->tpl_vars['field_name']->value=="Country:name") {?>
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4" for="id_country_invoice"><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
 <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
...
"<?php if ((isset($_smarty_tpl->tpl_vars['guestInformations']->value)&&isset($_smarty_tpl->tpl_vars['guestInformations']->value['id_country_invoice'])&&$_smarty_tpl->tpl_vars['guestInformations']->value['id_country_invoice']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_smarty_tpl->tpl_vars['guestInformations']->value)&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])) {?> selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
						...
						<label class="control-label col-sm-4 col-md-4" for="id_state_invoice"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>" />
						...
						<?php }?>
						<div class="form-group is_customer_param">
						<label class="control-label col-sm-4 col-md-4" for="other_invoice"><?php echo smartyTranslate(array('s'=>'Additional information'),$_smarty_tpl);?>
</label>
						<div class="col-sm-6 col-md-6">
						...
						<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>
						<div class="inline-infos required is_customer_param"><label class="col-sm-offset-4 col-sm-6 col-md-offset-4 col-md-6"><?php echo smartyTranslate(array('s'=>'You must register at least one phone number.'),$_smarty_tpl);?>
</label></div>
						<?php }?>
						<div class="form-group is_customer_param">
						<label class="control-label col-sm-4 col-md-4" for="phone_invoice"><?php echo smartyTranslate(array('s'=>'Home phone'),$_smarty_tpl);?>
</label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>" />
						...
						<div class="<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>required <?php }?>form-group">
						<label class="control-label col-sm-4 col-md-4" for="phone_mobile_invoice"><?php echo smartyTranslate(array('s'=>'Mobile phone'),$_smarty_tpl);?>
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?> <sup>*</sup><?php }?></label>
						<div class="col-sm-6 col-md-6">
...
" />
					...
					<div class="submit opc-add-save clearfix">
						...
						<button type="submit" name="submitAccount" id="submitAccount" class="btn btn-outline button button-medium"><span><?php echo smartyTranslate(array('s'=>'Save'),$_smarty_tpl);?>
</span></button>
